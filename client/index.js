...
var instance;
var user;
var contractAddress = "0x1f7722ACaD869FE12A3243d73163524B998DC37e";
...
async function myKitties() {
    ...
    var arrayId = await instance.methods.allNFTsPerOwner(user).call();

    console.log(arrayId);
    
    for (i = 0; i < arrayId.length; i++) {

        appendKitty(arrayId[1]);
